...
public class SABoneColliderBuilderInspector : MonoBehaviour
{
	/*
	public override void OnInspectorGUI()
	{
        ...
        {
            MakeMeshContents(boneColliderBuilder);
        }
        EditorGUILayout.EndHorizontal();
	}
	*/

    public void MakeMeshContents(SABoneColliderBuilder boneColliderBuilder)
    {
		boneColliderBuilder = GameObject.FindObjectOfType<SABoneColliderBuilder>();
		Debug.Log("in01");
        //if (boneColliderBuilder.edittingBoneColliderBuilderProperty != null)
       // {
			Debug.Log("in02");
